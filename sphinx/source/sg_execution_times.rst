...
Computation times
=================
**00:01.322** total execution time for 7 files **from all galleries**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_auto_examples_grouped_bar_plot_horizontal_grouped_bar_rick.py` (``examples/grouped_bar/plot_horizontal_grouped_bar_rick.py``)
     - 00:01.322
     - 0.0
   * - :ref:`sphx_glr_auto_examples_bar_plot_bar_rick.py` (``examples/bar/plot_bar_rick.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_examples_grouped_bar_plot_vertical_grouped_bar_rick.py` (``examples/grouped_bar/plot_vertical_grouped_bar_rick.py``)
     - 00:00.000
     - 0.0
